...
| :------------------ | :-------- | :------------ | :------------------------------------------------------------------------------------------------------------ |
| createPlayerAccount | User      | PlayerAccount | <p>Throw error if</p><p>1) PlayerAccount already exists</p><p>2) context\.auth\.id not equals to user\.id</p> |

### <a name="_k6i23y6tyf96"></a>**Game Room APIs**

| **Name**       | **Parameter**            | **Return** | **Rules**                                                                                                                                                                                                                                                                                                                                                          |
| :------------- | :----------------------- | :--------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| createGameRoom | GameRoom                 | GameRoom   | <p>Throw error if</p><p>1) player already in game</p><p>2) player already in room</p><p></p><p>else:</p><p>once the room has been created, the player should join the room automatically and immediately and their playerAccount should be updated</p>                                                                                                             |
