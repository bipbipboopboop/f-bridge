...
const PlayerHand = () => {
  ...
  if (isDesktop) return <PlayerHandWeb />;
  if (isLandscape) return <PlayerHandLandscape />;
  return <></>;
};
...
const PlayerHandLandscape = () => {
  ...
  return (
    <>
      ...
      <div className="w-[10%] flex flex-col absolute right-5 bottom-4 gap-y-2">
        <Button
          size={1}
          theme="green"
          className={!canPlayCard ? "opacity-0" : selectedCard ? "opacity-100" : "opacity-50"}
