...
export const chooseTeammate = functions.https.onCall(async (card: Card, context) => {
  ...
  const hiddenTrickPhase: TrickTakingPhaseHidden = {
    declarerTeam: {playerList: [gamePlayer, teammate], tricksWon: 0, tricksNeeded: 6 + highestBid.number},
    defenderTeam: {playerList: otherPlayers, tricksWon: 0, tricksNeeded: 7 - highestBid.number},
  };
